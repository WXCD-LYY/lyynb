package com.itheima.Map.demo01;
...
/*
    ...
    map集合的特点：
        1.Map集合是一个双列，一个元素包含两个值(一个key，一个value)
    ...
    1.HashMap集合的特点：
        1.HashMap集合底层是哈希表：查询的速度特别快
            JDK1.8之前：数组+单向链表
            JDK1.8之后：单向链表/红黑树(链表的长度超过8)：提高查询的速度
...
//        Integer v2 = map.remove("林志颖");
        int v2 = map.remove("林志颖"); // 自动拆箱 NullPointerException（空指针异常）
        System.out.println("v2:"+ v2); // v2:null
