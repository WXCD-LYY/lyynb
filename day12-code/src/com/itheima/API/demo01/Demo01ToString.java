package com.itheima.API.demo01;
...
public class Demo01ToString {
    public static void main(String[] args) {
        /*
            Person类默认继承了Object类，所有可以使用Object类中的toString方法
            String toString() 返回该对象的字符串表示。
         */

        Person p = new Person("张三",18);
        String s = p.toString();
        System.out.println(s); // com.itheima.API.demo01.Person@10f87f48 / abc / Person{name='张三', age=18}

        // 直接打印对象的名字，其实就是调用对象的toString   p=p.toString();
        System.out.println(p); // com.itheima.API.demo01.Person@10f87f48 / abc  / Person{name='张三', age=18}
